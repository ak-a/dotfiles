...
if ! exists('g:LogViewer_Filetypes')
    let g:LogViewer_Filetypes = 'log4j,virtu'
endif
...
highlight def LogViewerFrom   cterm=NONE ctermfg=NONE ctermbg=Cyan     gui=NONE guifg=NONE guibg=LightCyan
highlight def LogViewerTo     cterm=NONE ctermfg=NONE ctermbg=Green    gui=NONE guifg=NONE guibg=Cyan
