# Generated by Powerlevel10k configuration wizard on 2023-05-24 at 14:08 BST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 16959.
# Wizard options: compatible, rainbow, unicode, 24h time, blurred heads, blurred tails,
# 2 lines, dotted, full frame, darkest-ornaments, compact, concise, transient_prompt,
